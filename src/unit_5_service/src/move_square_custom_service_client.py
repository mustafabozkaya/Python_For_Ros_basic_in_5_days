...
move_bb8_in_square_service_client = rospy.ServiceProxy('/move_bb8_in_square_custom', mycostumservicemessage) # Create the connection to the service
move_bb8_in_square_request_object = mycostumservicemessageRequest() # Create an object of type EmptyRequest
...
move_bb8_in_square_request_object.duration = duration
