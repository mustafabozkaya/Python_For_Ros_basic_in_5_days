...
my_service = rospy.Service('/move_bb8_in_circle_custom', mycostumservicemessage , my_callback) # create the Service called move_bb8_in_circle with the defined callback
